    ...
    <Layout>
      <section className="text-gray-600 body-font relative">
        ...
        <div className="container px-5 py-24 mx-auto flex">
          <div
            className="lg:w-1/3 md:w-1/2 bg-cs-orange/10 rounded-xl p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10  shadow-xl shadow-gray-800"
          ...
          >
            <div className="bg-grey-500">
              ...
              <div className="grid grid-cols-[20px_auto] gap-2 text-black">
                <div className="col-span-2 title-font text-orange text-bold">
                  Hua Mak Campus
                </div>
                <div className="flex">
